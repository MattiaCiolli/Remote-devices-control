...
{
    public class IPDeviceCaller : DeviceCaller
    {

        public void CheckAll(string ipAddress_in, string badgeNumber_in)
        { }
        ...
        public double CheckTemperature(string ipAddress_in, string badgeNumber_in)
        {
            return 12.5;
        }

        public string CheckTime(string ipAddress_in, string badgeNumber_in)
        {
        ...
        public string CheckNodes(string ipAddress_in, string badgeNumber_in)
        {
            return "ok,ok,ok";
        }

        public string CheckVoltage(string ipAddress_in, string badgeNumber_in)
        {
            string pkg = ConnectAndGet(ipAddress_in, 49152);
